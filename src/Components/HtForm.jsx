...
{/* theftDetectedBy */}
        ...
        <FormControl fullWidth>
          ...
          <Grid xs={12} sm={6} item>
          <TextField label="External CT ratio if any" placeholder="Enter External CT ratio" name="externalCtRatio"variant="outlined" autocomplete="off" fullWidth required/>
          </Grid>
          <Grid xs={12} sm={6} item>
          <TextField label="Lab No." placeholder="Enter Lab No." variant="outlined" name='labNo' fullWidth autocomplete="off" required/>
          </Grid>
          <Grid xs={12} sm={6} item>
        ...
        <Typography gutterBottom variant="h6" sx={{marginTop:5}}>Details of Connected Loads</Typography>
          ...
          <Grid xs={12} sm={9} item>
            ...
            <Grid xs={12}  item  style={{marginTop:"20px"}}>
                <TextField label="Irrgularaties Observed" placeholder="Enter Observed Irregularities"  autocomplete="off" multiline rows={5} name="irregularitiesObserved" varient="outlined" fullWidth required />
            </Grid>
            <Grid xs={12} item style={{marginTop:"20px"}}>
